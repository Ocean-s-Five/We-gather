...
public interface CommentsRepository extends JpaRepository<Comments, Long> {
    ...
    @Query(value = "SELECT * FROM  comments c Full outer join users u on  u.id= c.user_id where raised_work_fund_id=?1", nativeQuery = true)
    public List<Comments> findComment(Long user_id);
